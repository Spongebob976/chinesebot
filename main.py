...
async def create_tables():
    async with aiosqlite.connect("chinese_bot.db") as db:
        ...
        initial_words = [
            ...
            ("家", "jiā", "Дом", "цзя"),
            ("书", "shū", "Книга", "шу"),
            ("医院", "yīyuàn", "Больница", "июань"),
            ("电视", "diànshì", "Телевизор", "дяньши"),
            ("市场", "shìchǎng", "Рынок", "шичан"),
            ("学习", "xuéxí", "Учиться", "сюэси"),
            ("这个", "zhège", "Это", "чжэгэ"),
            ("我们", "wǒmen", "Мы", "вомэнь"),
            ("吃", "chī", "Есть (кушать)", "чи"),
            ("喝", "hē", "Пить", "хэ"),
            ("去", "qù", "Идти", "цюй"),
            ("好", "hǎo", "Хорошо", "хао"),
            ("大", "dà", "Большой", "да"),
            ("小", "xiǎo", "Маленький", "сяо"),
            ("钱", "qián", "Деньги", "цянь"),
            ("天", "tiān", "День", "тянь"),
            ("年", "nián", "Год", "нянь"),
            ("人", "rén", "Человек", "жэнь"),
            ("中国", "zhōngguó", "Китай", "чжунго"),
            ("俄罗斯", "éluósī", "Россия", "элосы"),
            ("语言", "yǔyán", "Язык", "юйянь"),
            ("学校", "xuéxiào", "Школа", "сюэсяо"),
            ("商店", "shāngdiàn", "Магазин", "шандянь"),
            ("餐厅", "cāntīng", "Ресторан", "цантин"),
            ("火车", "huǒchē", "Поезд", "хочэ"),
            ("飞机", "fēijī", "Самолёт", "фэйцзи"),
            ("汽车", "qìchē", "Машина", "цичэ"),
            ("手机", "shǒujī", "Телефон", "шоуцзи"),
            ("电脑", "diànnǎo", "Компьютер", "дяньнао"),
            ("名字", "míngzì", "Имя", "минцзы"),
            ("工作", "gōngzuò", "Работа", "гунцзо"),
            ("今天", "jīntiān", "Сегодня", "цзиньтянь"),
            ("明天", "míngtiān", "Завтра", "минтянь"),
            ("昨天", "zuótiān", "Вчера", "цзотянь"),
            ("星期", "xīngqī", "Неделя", "синци"),
            ("月", "yuè", "Месяц", "юэ"),
            ("时间", "shíjiān", "Время", "шицзянь"),
            ("早上", "zǎoshang", "Утро", "цзаошан"),
            ("晚上", "wǎnshang", "Вечер", "ваньшан"),
            ("猫", "māo", "Кошка", "мао"),
            ("狗", "gǒu", "Собака", "гоу"),
            ("苹果", "píngguǒ", "Яблоко", "пингуо"),
            ("面包", "miànbāo", "Хлеб", "мяньбао"),
            ("牛奶", "niúnǎi", "Молоко", "нюнай"),
            ("红色", "hóngsè", "Красный", "хунсэ"),
            ("白色", "báisè", "Белый", "байсэ"),
            ("黑色", "hēisè", "Чёрный", "хэйсэ"),
        ]
